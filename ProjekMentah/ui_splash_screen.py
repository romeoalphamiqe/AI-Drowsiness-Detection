...
"}")
        ...
        self.label_title.setStyleSheet(u"color: rgb(52, 204, 14);")
...
"QProgressBar::chunk{\n"
"	border-radius: 10px;\n"
"	background-color: qlineargradient(spread:pad, x1:0, y1:0.511364, x2:1, y2:0.523, stop:0 rgba(52, 204, 14, 255), stop:1 rgba(170, 85, 255, 255));\n"
"}")
    ...
    def retranslateUi(self, SplashScreen):
        ...
        self.label_title.setText(QCoreApplication.translate("SplashScreen", u"<strong>Tired Detection</strong> APP", None))
        ...
        self.label_credits.setText(QCoreApplication.translate("SplashScreen", u"<strong>Created</strong>: Created by Kelompok 7", None))
    # retranslateUi
